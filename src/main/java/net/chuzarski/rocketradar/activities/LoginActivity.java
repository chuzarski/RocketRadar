...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserField = (EditText) findViewById(R.id.uname);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(user)) {
            mUserField.setError(getString(R.string.error_field_required));
            focusView = mUserField;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            //TODO auth and jump to activity here
